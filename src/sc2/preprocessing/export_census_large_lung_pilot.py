...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export a larger multi-dataset lung Census pilot.")
    ...
    parser.add_argument("--cells-per-dataset", type=int, default=2500)
    ...
    if args.output_name is None:
        output_name = (
            f"census_large_{args.tissue_general}_"
