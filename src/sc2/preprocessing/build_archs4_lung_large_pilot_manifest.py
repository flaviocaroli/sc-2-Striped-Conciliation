...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build a larger lung-filtered ARCHS4 pilot manifest.")
    ...
    parser.add_argument("--pilot-size", type=int, default=10000)
    ...
    print(f"saved large lung pilot manifest: {output_path}")
