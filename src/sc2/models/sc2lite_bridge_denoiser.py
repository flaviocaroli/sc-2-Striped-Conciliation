...
class SC2LiteBridgeDenoiser(nn.Module):
    """
    bulk adapter/head
    sc adapter/head
    pseudobulk adapter/head
    shared trunk
    """
    ...
    def __init__(
        ...
        self.pb_adapter = FeedForwardBlock(input_dim, adapter_dim, dropout=dropout)
        ...
        self.pb_head = nn.Linear(adapter_dim, input_dim)
