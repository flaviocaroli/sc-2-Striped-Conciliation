...
# Standard public GTEx V8 files commonly used in public workflows.
# If a URL stops working, replace it with the current link from:
...
EXPR_URL="${EXPR_URL:-https://storage.googleapis.com/gtex_analysis_v8/rna_seq_data/GTEx_Analysis_2017-06-05_v8_RSEMv1.3.0_gene_tpm.gct.gz}"

SAMPLE_ATTR_FILE="${GTEX_RAW_DIR}/GTEx_Analysis_v8_Annotations_SampleAttributesDS.txt"
EXPR_FILE="${GTEX_RAW_DIR}/GTEx_Analysis_2017-06-05_v8_RSEMv1.3.0_gene_tpm.gct.gz"
