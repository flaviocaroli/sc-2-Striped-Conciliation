...
def main():
    ...
    receipt = {
        "schema":
            "sc2-p3-scprint-count-thinning-results-receipt-v2",
        ...
        "evaluation_note":
            (
                "Coverage-specific model/dataset overlap and "
                "native retained-cell subset. Full, thinned and "
                "native scprint_mu count matrices are independently "
                "CP10K+log1p normalized on the same fixed gene "
                "overlap; target/baseline/masks are paired to the "
                "exact source rows retained by native preprocessing."
            ),
    }
